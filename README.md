...
*   **Resultados:** Microdatos socioeconómicos y demográficos a nivel nacional.
    ...
    *   *Modelo 2 Probabilidad de Adquirir una Vivienda Propia*: Al integrar datos del Censo 2020, el modelo cuantificó que contar con financiamiento formal hace que una mujer jefa de hogar tenga 22 veces más probabilidades de ser propietaria. Se identificó un nicho de 398,923 mujeres con perfil preferente que aún no poseen vivienda propia, representando el mercado objetivo primario para los nuevos desarrollos de Infonavit.
 
      
*   **Geoinformática:** Creación de un **Mapa de Calor (Heatmap) a nivel municipal** para la localización geográfica de la demanda potencial.
*   **Stack:** R / Python, Scikit-learn (Lasso), Análisis Geoespacial.

    
*   **Reducción de Sesgos:** Uso de técnicas de penalización para asegurar modelos robustos y generalizables.
